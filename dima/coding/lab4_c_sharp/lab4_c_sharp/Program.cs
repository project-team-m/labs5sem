...
namespace ConsoleApp1
{
    class Program
    {
        ...
        static void ToRGB()
        {
            FileStream input = new FileStream("200x200.jpeg", FileMode.Open);
            FileStream f1 = new FileStream("1.jpeg", FileMode.Create);
            FileStream f2 = new FileStream("2.jpeg", FileMode.Create);
            FileStream f3 = new FileStream("3.jpeg", FileMode.Create);
            input.CopyTo(f1);
