...
def show_stocks(request):
    if DB.a.login and DB.a.lvl == 3:
        ...
        return render(request, 'root/show_table.html',
                      {'tittles': DB.a.show_stocks()[0], 'strings': DB.a.show_stocks()[1:], 'link': link, 'last': DB.a.show_stocks()[-1], 'scripts': save})
    DB.scripts = 'wrong password or login'
    return HttpResponseRedirect(reverse('main_form:index'))
...
def show_stock(request):
    if DB.a.login and DB.a.lvl == 3:
        ...
        return render(request, 'root/show_table.html',
                      {'tittles': DB.a.show_stock()[0], 'strings': DB.a.show_stock()[1:], 'link': link, 'last': DB.a.show_stock()[-1], 'scripts': save})
    DB.scripts = 'wrong password or login'
    return HttpResponseRedirect(reverse('main_form:index'))
...
def show_clients(request):
    if DB.a.login and DB.a.lvl == 3:
        ...
        return render(request, 'root/show_table.html',
                      {'tittles': DB.a.show_clients()[0], 'strings': DB.a.show_clients()[1:], 'link': link, 'last': DB.a.show_clients()[-1], 'scripts': save})
    DB.scripts = 'wrong password or login'
    return HttpResponseRedirect(reverse('main_form:index'))
...
def show_workers(request):
    if DB.a.login and DB.a.lvl == 3:
        ...
        return render(request, 'root/show_table.html',
                      {'tittles': DB.a.show_workers()[0], 'strings': DB.a.show_workers()[1:], 'link': link, 'last': DB.a.show_workers()[-1], 'scripts': save})
    DB.scripts = 'wrong password or login'
    return HttpResponseRedirect(reverse('main_form:index'))
...
def show_positions(request):
    if DB.a.login and DB.a.lvl == 3:
        ...
        return render(request, 'root/show_table.html',
                      {'tittles': DB.a.show_positions()[0], 'strings': DB.a.show_positions()[1:], 'link': link, 'last': DB.a.show_positions()[-1], 'scripts': save})
    DB.scripts = 'wrong password or login'
    return HttpResponseRedirect(reverse('main_form:index'))
...
def show_basket(request):
    if DB.a.login and DB.a.lvl == 3:
        ...
        return render(request, 'root/show_table.html',
                      {'tittles': DB.a.show_basket()[0], 'strings': DB.a.show_basket()[1:], 'link': link, 'last': DB.a.show_basket()[-1], 'scripts': save})
    DB.scripts = 'wrong password or login'
    return HttpResponseRedirect(reverse('main_form:index'))
...
def show_orders(request):
    if DB.a.login and DB.a.lvl == 3:
        ...
        return render(request, 'root/show_table.html',
                      {'tittles': DB.a.show_orders()[0], 'strings': DB.a.show_orders()[1:], 'link': link, 'last': DB.a.show_orders()[-1], 'scripts': save})
    DB.scripts = 'wrong password or login'
    return HttpResponseRedirect(reverse('main_form:index'))
