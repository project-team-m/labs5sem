...
def show_tables(request):
    if BD.a.login and BD.a.lvl == 0:
        return render(request, 'op_od/main_opod.html', {'tables': BD.a.get_tables()})
...
def show_components(request):
    if BD.a.login and BD.a.lvl == 0:
        save = BD.scripts
        BD.scripts = None
        link = 'http://127.0.0.1:8000/op_od/enter_components/'
        link2 = 'http://127.0.0.1:8000/op_od/enter_components_s/'
        return render(request, 'op_od/show_table.html',
...
def show_table_old(request):
    if BD.a.login and BD.a.lvl == 0:
        ...
        if '_apply' in request.POST:
            ...
            return HttpResponseRedirect(reverse('op_od:show_table'))
        else:
            return render(request, 'op_od/backups.html',
